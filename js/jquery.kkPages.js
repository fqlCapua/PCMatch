	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			if($AllMth > $Mth){
					...
					var PagesMthTxt = "<span>共<b>"+$AllMth+"</b>条，共<b>"+PagesMth+"</b>页</span><br class='clearfix'/><br /><br />";
				...
				$PagesPrev.click(function(){
						...
						if(OldNav.text() == 1){layer.msg("友情提示：\n\n不要再点啦~已经是首页啦！");}else{
				...
				$PagesNext.click(function(){
						...
						if(OldNav.text() == PagesMth){layer.msg("友情提示：\n\n不要再点啦~已经是最后一页啦！");}else{
