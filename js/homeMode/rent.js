    var user_selectors = Mock.mock({
        "choices":{
            ...
            "h_subway": [ "1号线", "2号线"],
            "h_sum": ["600元以下","600-1000元","1000-1500元","1500-2000元","2000-2500元","2500-3000元","3000元以上",
],
            "h_type": ["一室","两室","三室","四室","四室以上"],
    ...
    app.controller("AllrentCtr", function($scope) {
        ...
        $scope.getDetail=function($event){
           ...
           var url="index.html#/rent_detail?hid="+hid;
             window.open(url);
        }
